...
on('#ajax', 'click', '.select_serve', function() {
  ...
  if (_this.querySelector(".price_acc_td")) {
    serve_price = _this.querySelector(".price_acc").innerHTML*1
  } else {
  ...
  if (!_this.classList.contains("hover")){
    ...
    _this.querySelector(".action_text").innerHTML = '<span class="wow fadeIn" data-wow-duration="0.2s">Выбрано</span>';
  }
  else {
    ...
    _this.querySelector(".action_text").innerHTML = '<span class="wow fadeIn" data-wow-duration="0.2s">Выбрать</span>';
  }
});
