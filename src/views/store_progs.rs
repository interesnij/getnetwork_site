...
pub async fn edit_content_store_page(session: Session, mut payload: Multipart, req: HttpRequest, _id: web::Path<i32>) -> actix_web::Result<HttpResponse> {
...
pub async fn edit_content_store(session: Session, mut payload: Multipart, req: HttpRequest, _id: web::Path<i32>) -> impl Responder {
    use crate::schema::stores::dsl::stores;
...
pub async fn get_store_page(session: Session, req: HttpRequest, param: web::Path<(i32,i32)>) -> actix_web::Result<HttpResponse> {
    ...
    let _category_setores = _category.get_stores_ids();
